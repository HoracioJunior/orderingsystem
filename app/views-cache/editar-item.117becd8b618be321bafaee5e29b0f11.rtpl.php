<?php if(!class_exists('Rain\Tpl')){exit;}?><div class="main-content">
    <div class="main-content-inner">
        ...
        <div class="page-content">
            ...
            <!-- form inicio-->
            <form action="/admin/menu/editar-item" method="post" enctype="multipart/form-data">
                <div class="row row-formatacao">
                    <div class="col-md-4 col-formatacao">
                        <input type="text" name="id_produto" value="<?php echo htmlspecialchars( $produto["id_produto"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                ...
                <div class="row row-formatacao">
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <textarea value="<?php echo htmlspecialchars( $produto["nome_produto"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="form-control" rows="3" name="descricao_produto"></textarea>
                        </div>
                    </div>
                    <div class="col-md-4">
