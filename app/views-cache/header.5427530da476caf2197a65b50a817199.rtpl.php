    ...
    <aside class="main-sidebar">
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li><a href="/gestor"><i class="fa fa-tachometer-alt"></i> <span>Dashboard</span></a></li>
                <li class="treeview">
                    <a href=""><i class="fa fa-file-alt"></i> <span>Cardapio</span>
                        <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span>
                    </a>
                    <ul class="treeview-menu">
                        <li><a href="/gestor/menu/categorias">Adicionar Categoria</a></li>
                        <li><a href="/gestor/menu/cadastrar-item">Adicionar Item</a></li>
                        <li><a href="/gestor/menu/menu-itens">Listar Itens</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href=""><i class="fa fa-shopping-basket"></i> <span>Pedidos</span>
                        <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span>
                    </a>
                    <ul class="treeview-menu">
                        <li><a href="/gestor/pedidos/novos-pedidos">Novos Pedidos</a></li>
                        <li><a href="/gestor/pedidos/pedidos-pedentes">Pedidos Pendentes</a></li>
                        <li><a href="/gestor/pedidos/pedidos-completos">Pedidos Completos</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href=""><i class="fa fa-file-export"></i> <span>Relatorios</span>
                        <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span>
                    </a>
                    <ul class="treeview-menu">
                        <li><a href="/gestor/relatorio/gerar-relatorio">Gerar Relatorio</a></li>
                    </ul>
                </li>

                <li><a href="/gestor/minha-conta"><i class="fa fa-user"></i> <span>Minha Conta</span></a></li>
                <li><a href="/gestor/fechar-e-abrir-sistema"><i class="fa fa-cogs"></i> <span>Fechar ou Abrir</span></a></li>
