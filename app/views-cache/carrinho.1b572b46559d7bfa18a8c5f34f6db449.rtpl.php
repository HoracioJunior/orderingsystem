    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-3 box-pagamento mb-4 ">
                ...
                <div class="row delivery-pickup">
                    <div class="col-12 ">
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="delivery" value="1" onclick="mostrar(0)" name="radio" class="custom-control-input" checked>
                        ...
                        <div class="custom-control custom-radio custom-control-inline radio2">
                            <input type="radio" id="pickup" name="radio" onclick="mostrar(1)" value="2" class="custom-control-input" >
                    ...
                    <div class="row">
                        <div class="col-12">
                            <select class="custom-select custom-select mb-3 mt-3" id="select">
                ...
                <div class="row taxa-delivery mb-3 " id="taxa-delivery" >
                    <div class="col-md-8 ">Taxa de Delivery:</div>
                    <div class="col-md-4 text-right ">150 MZN</div>
                </div>
                <hr>
